...
///
/// ```
/// use better_subscriber::{EnvFilter, fmt, prelude::*};
///
...
impl EnvFilter {
    ...
    /// use better_subscriber::filter::{EnvFilter, LevelFilter};
    ///
    /// # fn docs() -> Result<EnvFilter, better_subscriber::filter::ParseError> {
    /// # let directives = "";
    /// EnvFilter::builder()
    ///     .with_default_directive(LevelFilter::ERROR.into())
    ///     .parse(directives)
    ...
    ///
    /// # fn docs() -> Result<EnvFilter, better_subscriber::filter::FromEnvError> {
    ...
    ///
    /// ```rust
    /// use better_subscriber::filter::{EnvFilter, Directive};
    ///
