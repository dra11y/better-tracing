...
///     FormattedFields,
/// };
/// use better_subscriber::registry::LookupSpan;
///
/// struct MyFormatter;
///
...
///
/// ```rust
/// let format = better_subscriber::fmt::format()
...
impl<F, T> Format<F, T> {
    ...
    ///
    /// ```
    /// # use better_subscriber::fmt::format;
    /// better_subscriber::fmt()
    ///    .pretty()
    ///    .with_ansi(false)
...
pub(super) mod test {
    ...
    fn with_line_number_and_file_name() {
        ...
        let expected = Regex::new(&format!(
            "^fake time better_subscriber::fmt::format::test: {}:[0-9]+: hello\n$",
            current_path()
    ...
    fn with_line_number() {
        ...
        let expected =
            Regex::new("^fake time better_subscriber::fmt::format::test: [0-9]+: hello\n$")
                .unwrap();
        let _default = set_default(&subscriber.into());
        tracing::info!("hello");
        let res = make_writer.get_string();
    ...
    fn with_filename() {
        ...
        let subscriber = crate::fmt::Subscriber::builder()
            ...
            .with_timer(MockTime);
        let expected = &format!(
            "fake time better_subscriber::fmt::format::test: {}: hello\n",
            current_path(),
        );
    ...
    fn with_thread_ids() {
        ...
        let subscriber = crate::fmt::Subscriber::builder()
            ...
            .with_timer(MockTime);
        let expected =
            "fake time  INFO ThreadId(NUMERIC) better_subscriber::fmt::format::test: hello\n";
    ...
    fn pretty_default() {
        ...
        let subscriber = crate::fmt::Subscriber::builder()
            ...
            .with_timer(MockTime);
        let expected = format!(
            r#"  fake time  INFO better_subscriber::fmt::format::test: hello
    at {}:NUMERIC
...
"#,
    ...
    mod default {
        ...
        #[test]
        fn with_ansi_true() {
            let expected = "\u{1b}[2mfake time\u{1b}[0m \u{1b}[32m INFO\u{1b}[0m \u{1b}[2mbetter_subscriber::fmt::format::test\u{1b}[0m\u{1b}[2m:\u{1b}[0m hello\n";
        ...
        #[test]
        fn with_ansi_false() {
            let expected = "fake time  INFO better_subscriber::fmt::format::test: hello\n";
        ...
        #[test]
        fn without_level() {
            let expected = "fake time better_subscriber::fmt::format::test: hello\n";
            test_without_level(expected, crate::fmt::Subscriber::builder())
        }

        #[test]
        fn overridden_parents() {
            let expected = "fake time span1{span=1}:span2{span=2}: better_subscriber::fmt::format::test: hello\n";
        ...
        fn overridden_parents_in_scope() {
            test_overridden_parents_in_scope(
                "fake time span3{span=3}: better_subscriber::fmt::format::test: hello\n",
                "fake time span1{span=1}:span2{span=2}: better_subscriber::fmt::format::test: hello\n",
    ...
    mod compact {
        ...
        #[test]
        fn overridden_parents() {
            let expected = "fake time span1:span2: better_subscriber::fmt::format::test: hello span=1 span=2\n";
        ...
        fn overridden_parents_in_scope() {
            test_overridden_parents_in_scope(
                "fake time span3: better_subscriber::fmt::format::test: hello span=3\n",
                "fake time span1:span2: better_subscriber::fmt::format::test: hello span=1 span=2\n",
    ...
    mod pretty {
        ...
        fn pretty_default() {
            ...
            let subscriber = crate::fmt::Subscriber::builder()
                ...
                .with_timer(MockTime);
            let expected = format!(
                "  fake time  INFO better_subscriber::fmt::format::test: hello\n    at {}:NUMERIC\n\n",
                file!()
            );
