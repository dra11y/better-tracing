...
pub trait MakeWriter<'a> {
    ...
    /// use better_subscriber::fmt::writer::MakeWriter;
...
pub trait MakeWriterExt<'a>: MakeWriter<'a> {
    ...
    /// ```
    /// use tracing::Level;
    /// use better_subscriber::fmt::writer::MakeWriterExt;
    ///
    ...
    ///
    /// better_subscriber::fmt().with_writer(mk_writer).init();
    /// ```
    ///
...
/// # use better_subscriber::fmt::writer::BoxMakeWriter;
///
...
///     };
///
///     better_subscriber::fmt().with_writer(writer).finish()
/// }
/// ```
///
...
/// `better-subscriber`'s `FormatEvent`/`FormatTime` traits expect a
