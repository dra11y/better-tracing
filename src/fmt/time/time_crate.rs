...
impl LocalTime<well_known::Rfc3339> {
    ...
    ///
    /// ```
    /// use better_subscriber::fmt::{self, time};
    ///
...
impl<F: Formattable> LocalTime<F> {
    ...
    ///
    /// ```
    /// use better_subscriber::fmt::{self, time::LocalTime};
...
impl<F: Formattable> UtcTime<F> {
    ...
    ///
    /// ```
    /// use better_subscriber::fmt::{self, time::UtcTime};
    /// use time::macros::format_description;
    ///
...
impl OffsetTime<well_known::Rfc3339> {
    ...
    ///
    /// ```
    /// use better_subscriber::fmt::time::OffsetTime;
    ///
    /// #[tokio::main]
    /// async fn run() {
...
impl<F: time::formatting::Formattable> OffsetTime<F> {
    ...
    ///
    /// ```
    /// use better_subscriber::fmt::{self, time::OffsetTime};
    /// use time::macros::format_description;
    /// use time::UtcOffset;
    ///
