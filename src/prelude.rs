//! The `better-subscriber` prelude.
//!
//! This brings into scope a number of extension traits that define methods on
//! types defined here and in other crates.

pub use crate::field::{
    MakeExt as __better_subscriber_field_MakeExt,
    RecordFields as __better_subscriber_field_RecordFields,
};
pub use crate::layer::{
    Layer as __better_subscriber_Layer, SubscriberExt as __better_subscriber_SubscriberExt,
};
